...
export default function TopBar({ activePage, onMenuClick, sidebarWidth = 244 }) {
  ...
  return (
    <header style={{
      ...
      padding: '0 24px',
      zIndex: 100,
      transition: 'background .3s, border-color .3s, left .28s ease',
    }}>
      {/* Mobile menu + title */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12.5, color: 'var(--text-s)', marginTop: 1 }}>
            {meta.sub}
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
        ...
        <div
          ...
          style={{
            ...
            color: 'var(--text-s)', transition: 'all .2s',
          }}
        >
          ...
          <input
            ...
            style={{
              ...
              fontSize: 12.5, width: 150, outline: 'none',
            }}
          />
        </div>
        ...
        <button
          ...
          style={{
            ...
            color: 'var(--text-s)', cursor: 'pointer', transition: 'all .2s',
          }}
